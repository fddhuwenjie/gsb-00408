...
import FailureReviewPage from '@/pages/FailureReview';
    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<ProtectedRoute roles={['editor', 'reviewer', 'admin']}><Layout /></ProtectedRoute>}>
          ...
          <Route path="failure-reviews" element={<ProtectedRoute roles={['reviewer', 'admin']}><FailureReviewPage /></ProtectedRoute>} />
